        ...
        <div class="container px-3">
            <div id="dialog" style="text-align: center;font-size: 36px;"><!--form canvas-->
              <h2 style="font-size: 40px; color: white;">Congrats</h2>
               <p class="text-warning pt-4">Hey <?php echo $fullName?> your username is <?php echo $_SESSION['username'];?>.</p>
                <p class="px-5 pt-3 pb-5 text-success" style="font-size: 36px; font-weight: 500; font-style: italic;">
                    You are successfully register in our MyGlobalBook Community.Enjoy and connect with your friends all over the world.Go and <a href="index.php" style="color: rgb(255, 235, 0);"> login </a>
                </p>
            </div>
        </div>
    </div>
